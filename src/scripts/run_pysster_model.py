...
output_folder =  DATA + "explore-cgi/data/interim/cgi_ind_exp/pysster_output/model_test_run_10_17_18/"
if not os.path.isdir(output_folder):
    os.makedirs(output_folder)

#load the pysster prediction model
model = utils.load_model("/mnt/isilon/dbhi_bfx/perry/brian/explore_cgi/data/interim/cgi_ind_exp/pysster_output/run_10_9_18_2/model.pkl")

add_cgi_features = [DATA + "explore-cgi/data/interim/cgi_ind_exp/add_feat/cgi.indel.unsample__1kg.out"]
#                    DATA + "explore-cgi/data/interim/cgi_ind_exp/add_feat/cgi.indel.unsample__20120824_combined_mask.out",
#                    DATA + "explore-cgi/data/interim/cgi_ind_exp/add_feat/cgi.indel.unsample__ahmad_status.out",
...
#                    DATA + "explore-cgi/data/interim/cgi_ind_exp/add_feat/cgi.indel.unsample__closest.out",
...
#                    DATA + "explore-cgi/data/interim/cgi_ind_exp/add_feat/cgi.indel.unsample__microsat.out",
